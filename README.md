#  Performance testing tools and info.
...
transfer-test.sh - Debian-based script for upload/download testing.  populate varriables in the script headers and run with `sudo ./transfer-test.sh`
